...
- 【语言与事实硬性规则】只写自然、口语化的简体中文。不得输出繁体字、拼音/英文碎片与中文硬拼（AI、Offer、QS 等常见术语除外）、生造黑话或无意义词组。不得编造或暗示未经当前账号事实支持的年龄、前任身份、公司、学校、收入、营收、团队人数、Offer 数量、日期、阶段成果；没有已确认事实时，请使用“有人/不少人/这类人”等泛化表达，不能用具体数字凑冲突。
