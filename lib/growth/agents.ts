...
- 对标法没有与账号匹配且通过内容时效判断的近期或常青原链接时不得生成；蹭流量仍只允许7天内来源。
...
const NATIVE_METHOD_DIVERSITY_PLAYBOOK: Partial<Record<TitleMethodId, string>> = {
  ...
  scarce_material: "三个候选必须使用三种不同的资料载体与决策任务。可选载体包括：招聘节点日历、岗位JD拆解卡、面试追问库、投递结果复盘页、项目证据表、Offer比较尺、岗位排除题库、行业适配坐标、内推进度表、家庭约束单、能力证据索引、风险检查卡。不要连续输出“某某表/清单/路线图”，也不能只替换资料名称；正文承诺必须说明这份资料具体帮助读者判断什么。",
  ...
  inventory: "三个候选必须盘点三类不同对象或阶段，例如日期窗口、岗位风险、简历证据、面试追问、投递结果、Offer条款、家庭约束、现金流、客户资源、可迁移能力；数字和“几个坑”不是新题，盘点对象与使用场景必须不同。",
};
...
const EXECUTIVE_CONTRARIAN_ANGLES: ContrarianAngle[] = [
  ...
  { cue: "拥有利润责任 → 不等于掌握客户选择权", usedWhen: /利润责任.*客户|客户选择权.*利润/u },
  { cue: "全球头衔高 → 本地市场影响力未必强", usedWhen: /全球头衔.*本地|本地市场.*头衔/u },
  { cue: "股权数量多 → 兑现价值仍有不确定性", usedWhen: /股权.*兑现|兑现价值.*股权/u },
  { cue: "进入董事会 → 未必拥有招聘和预算权", usedWhen: /董事会.*招聘.*预算|预算权.*董事会/u },
  { cue: "扭亏经验强 → 未必擅长从零增长", usedWhen: /扭亏.*增长|从零增长.*扭亏/u },
  { cue: "并购项目多 → 整合落地能力仍需证明", usedWhen: /并购.*整合|整合.*并购/u },
  { cue: "跨国经历多 → 本地监管仍需重新学习", usedWhen: /跨国.*监管|本地监管.*跨国/u },
  { cue: "资历足够深 → 一线工具能力可能生疏", usedWhen: /资历.*工具|工具能力.*资历/u },
  { cue: "危机处理出色 → 日常经营未必稳定", usedWhen: /危机.*日常经营|日常经营.*危机/u },
  { cue: "公开演讲受欢迎 → 不等于有人愿意付费", usedWhen: /演讲.*付费|付费.*演讲/u },
  { cue: "粉丝数量多 → 决策咨询信任未必形成", usedWhen: /粉丝.*咨询|咨询信任.*粉丝/u },
  { cue: "营收规模大 → 现金转化效率未必高", usedWhen: /营收.*现金转化|现金转化.*营收/u },
  { cue: "过去成功过 → 新周期仍要重新验证", usedWhen: /过去成功.*新周期|新周期.*成功/u },
  { cue: "老板关系好 → 职业路径未必更清楚", usedWhen: /老板关系.*职业路径|职业路径.*老板/u },
  { cue: "内部晋升快 → 外部市场级别未必同步", usedWhen: /内部晋升.*外部|外部市场.*晋升/u },
  { cue: "任职时间长 → 忠诚不能替代市场能力", usedWhen: /任职.*忠诚|忠诚.*市场能力/u },
  { cue: "奖金比例高 → 总收入稳定性反而更低", usedWhen: /奖金比例.*稳定|收入稳定.*奖金/u },
  { cue: "客户联系人多 → 合同关系未必属于个人", usedWhen: /客户联系人.*合同|合同关系.*联系人/u },
  { cue: "团队很忠诚 → 不等于能跟随进入新组织", usedWhen: /团队.*忠诚.*新组织|新组织.*团队/u },
  { cue: "方法论成熟 → 未必能做成标准产品", usedWhen: /方法论.*标准产品|产品.*方法论/u },
  { cue: "会议话语权高 → 不等于市场有影响力", usedWhen: /会议.*话语权.*市场|市场影响.*会议/u },
  { cue: "商业感觉敏锐 → 个人报价仍需验证", usedWhen: /商业.*敏锐.*报价|个人报价.*商业/u },
  { cue: "投资人认识多 → 融资承诺未必真实", usedWhen: /投资人.*融资|融资承诺.*投资/u },
  { cue: "媒体曝光多 → 客户转化未必发生", usedWhen: /媒体.*客户转化|客户转化.*媒体/u },
  { cue: "英语表达好 → 全球业务能力仍需证据", usedWhen: /英语.*全球业务|全球业务.*英语/u },
  { cue: "数字化头衔新 → 技术理解未必深入", usedWhen: /数字化头衔.*技术|技术理解.*数字化/u },
  { cue: "参与AI项目 → 不等于掌握AI能力", usedWhen: /AI项目.*AI能力|AI能力.*项目/iu },
  { cue: "管理课程学得多 → 行为改变未必发生", usedWhen: /管理课程.*行为|行为改变.*课程/u },
  { cue: "平台流量很大 → 个人线索未必留下", usedWhen: /平台流量.*个人线索|个人线索.*流量/u },
  { cue: "大公司履历完整 → 创业团队适配仍未知", usedWhen: /大公司.*创业团队|创业.*大公司/u },
  { cue: "行业奖项多 → 真实需求未必存在", usedWhen: /行业奖.*需求|真实需求.*奖/u },
  { cue: "海外任职久 → 跨文化领导仍需结果证明", usedWhen: /海外任职.*跨文化|跨文化.*结果/u },
];

const OVERSEAS_HUMAN_PAIN_ANGLES: ContrarianAngle[] = [
  // usedWhen 必须识别“同一现场的自然改写”，不能只匹配 cue 的原词。
  // 否则历史里已经出现“申请页卡着不动”，选择器仍会把“申请系统不更新”
  // 当作新角度，随后又被语义终审挡回，造成用户反复点击仍交付失败。
  { cue: "申请系统状态一直不更新", usedWhen: /(?:(?:申请|网申).*(?:系统|页面|状态|卡|刷新|不更新|没回音))|(?:(?:状态|页面).*(?:不更新|卡住|刷新))/u },
  { cue: "拒信到邮箱却不敢点开", usedWhen: /拒信|邮箱.*(?:不敢|点开|录用|结果)/u },
  { cue: "室友讨论Offer时选择沉默", usedWhen: /室友.*(?:Offer|录用)|(?:Offer|录用).*室友/iu },
  { cue: "毕业典礼临近仍说不清去向", usedWhen: /毕业.*(?:典礼|去向|去哪|工作|上班|焦虑)|(?:去向|去哪).*(?:毕业|工作)/u },
  ...
  { cue: "面试撞上答辩却不敢放弃任何一边", usedWhen: /(?:面试|投岗).*(?:答辩|论文)|(?:答辩|论文).*(?:面试|投岗)/u },
  { cue: "签证倒计时逼近却没有岗位顺序", usedWhen: /(?:签证|工签|续签).*(?:倒计时|岗位|到期|资格|不对口)|倒计时.*岗位/u },
  ...
  { cue: "学位证明未出却被催入职材料", usedWhen: /学位(?:证|证明).*(?:入职|材料)|(?:入职|材料).*学位(?:证|证明)/u },
  ...
  { cue: "测评链接今晚到期却还没敢开始", usedWhen: /测评.*(?:到期|链接|不敢|开始)|链接.*今晚.*到期/u },
  { cue: "终面结果未出保底Offer却要当天回复", usedWhen: /终面.*(?:保底|回复)|保底.*(?:当天|截止|终面)/iu },
  { cue: "凌晨面试结束第二天还要交论文", usedWhen: /凌晨.*面试|面试.*第二天.*论文|时差.*面试/u },
  { cue: "招聘官追问最早入职日却还没答辩", usedWhen: /最早入职.*答辩|招聘官.*入职日/u },
  { cue: "网申要填本地地址却还没决定城市", usedWhen: /(?:本地地址|居住地址).*(?:城市|网申)|网申.*地址/u },
  { cue: "学校邮箱快停用却还有申请没结束", usedWhen: /学校邮箱.*(?:停用|申请)|邮箱.*停用/u },
  { cue: "推荐人休假而背调截止日在逼近", usedWhen: /推荐人.*(?:休假|背调|截止)|背调.*推荐人/u },
  { cue: "群面通知只给一天准备却找不到搭档", usedWhen: /群面.*(?:一天|准备|搭档)|搭档.*群面/u },
  { cue: "收到异地终面邀请却买不起临时机票", usedWhen: /异地.*终面.*机票|终面.*机票/u },
  { cue: "招聘会加了联系人却不知道怎么跟进", usedWhen: /招聘会.*(?:联系人|跟进)|联系人.*招聘会/u },
  { cue: "实习转正口头答应却迟迟没有书面确认", usedWhen: /实习.*转正.*(?:口头|书面)|转正.*书面/u },
  { cue: "国内号码收不到验证码卡在网申最后一步", usedWhen: /(?:号码|验证码).*(?:网申|申请)|网申.*验证码/u },
];
...
const EXECUTIVE_HUMAN_PAIN_ANGLES: ContrarianAngle[] = [
  ...
  { cue: "背调电话打到现公司却还没谈妥Offer", usedWhen: /背调.*现公司|现公司.*背调/iu },
  { cue: "候选公司催入职但交接名单还没写完", usedWhen: /催入职.*交接|交接.*入职/u },
  { cue: "老板临时加薪却没有改变职责边界", usedWhen: /加薪.*职责边界|职责.*加薪/u },
  { cue: "行业大会遇见前同事却说不清现在做什么", usedWhen: /行业大会.*前同事|前同事.*说不清/u },
  { cue: "孩子升学要换城市而新机会不能远程", usedWhen: /孩子.*升学.*城市|升学.*远程/u },
  { cue: "父母体检需要陪同却撞上关键面试", usedWhen: /父母.*体检.*面试|面试.*体检/u },
  { cue: "老客户来问新服务却不敢单独报价", usedWhen: /老客户.*(?:新服务|报价)|单独报价/u },
  { cue: "合伙协议发来后才发现退出条款没谈", usedWhen: /合伙.*退出条款|退出条款/u },
  { cue: "公司要签长期激励却看不懂归属条件", usedWhen: /长期激励.*(?:归属|条件)|归属条件/u },
  { cue: "外部Offer只保留三天而家人意见相反", usedWhen: /Offer.*(?:三天|家人)|家人.*Offer/iu },
  { cue: "个人品牌有流量却没人愿意为咨询付费", usedWhen: /个人品牌.*(?:流量|付费)|流量.*咨询.*付费/u },
  { cue: "新老板上任后第一次被移出核心会议", usedWhen: /新老板.*核心会议|移出.*会议/u },
];
...
const OVERSEAS_SCARCE_MATERIAL_ANGLES: ContrarianAngle[] = [
  ...
  { cue: "岗位描述版本差异页：识别职责变化", usedWhen: /岗位描述.*(?:版本|差异)|职责变化/u },
  { cue: "申请优先级看板：先投高匹配岗位", usedWhen: /申请.*优先级.*看板|高匹配.*岗位/u },
  { cue: "面试证据索引：按能力快速取案例", usedWhen: /面试.*证据.*索引|能力.*案例.*索引/u },
  ...
  { cue: "搬迁住房地图：估算通勤和房租", usedWhen: /搬迁.*住房.*地图|通勤.*房租.*地图/u },
  { cue: "通勤模拟路线：验证真实到岗成本", usedWhen: /通勤.*模拟.*路线|到岗成本/u },
  { cue: "姓名发音卡：避免跨语种称呼出错", usedWhen: /姓名.*发音.*卡|跨语种.*称呼/u },
  { cue: "自我介绍录音库：对比三种岗位版本", usedWhen: /自我介绍.*录音|岗位版本.*录音/u },
  { cue: "招聘官问答记录：复盘真实关注点", usedWhen: /招聘官.*问答.*记录|真实关注点/u },
  { cue: "拒信模式热图：识别卡在哪一轮", usedWhen: /拒信.*热图|卡.*一轮/u },
  { cue: "面试题覆盖矩阵：找到准备空白", usedWhen: /面试题.*覆盖.*矩阵|准备空白/u },
  { cue: "STAR证据剪贴板：保留数字与角色", usedWhen: /STAR.*证据|数字.*角色.*剪贴/iu },
  { cue: "企业文化证据日志：拒绝只看口号", usedWhen: /企业文化.*日志|文化.*口号/u },
  { cue: "直属经理访谈单：判断带人方式", usedWhen: /直属经理.*访谈|带人方式/u },
  { cue: "团队流动问题单：核验真实稳定性", usedWhen: /团队.*流动.*问题|真实稳定性/u },
  { cue: "产品体验拆解页：准备业务型面试", usedWhen: /产品体验.*拆解|业务型面试/u },
  { cue: "行业术语词典：补齐中文业务表达", usedWhen: /行业术语.*词典|中文业务.*表达/u },
  { cue: "业务指标速查页：讲清项目商业影响", usedWhen: /业务指标.*速查|商业影响/u },
  { cue: "信息披露边界卡：防止案例泄密", usedWhen: /信息披露.*边界|案例泄密/u },
  { cue: "作品集版本树：防止岗位材料串版", usedWhen: /作品集.*版本树|材料串版/u },
  { cue: "简历关键词热图：核对岗位覆盖度", usedWhen: /简历.*关键词.*热图|岗位覆盖/u },
  { cue: "测评异常恢复卡：记录断网重进步骤", usedWhen: /测评.*恢复.*卡|断网.*重进/u },
  { cue: "签证材料效期盘：提前补临期文件", usedWhen: /签证.*效期|临期.*文件/u },
  { cue: "推荐人授权话术：先确认背调边界", usedWhen: /推荐人.*授权.*话术|背调边界/u },
  { cue: "双语切换脚本：练跨语言面试转场", usedWhen: /双语.*切换.*脚本|跨语言.*转场/u },
  { cue: "薪资谈判证据页：支撑期望数字", usedWhen: /薪资谈判.*证据|期望数字/u },
  { cue: "通知期邮件包：统一离职与入职日期", usedWhen: /通知期.*邮件包|离职.*入职.*日期/u },
  { cue: "入职文件目录：一次核齐跨境材料", usedWhen: /入职文件.*目录|跨境材料/u },
  { cue: "入职关系地图：安排首周关键沟通", usedWhen: /入职.*关系.*地图|首周.*沟通/u },
  { cue: "工作许可决策树：判断每条申请路径", usedWhen: /工作许可.*决策树|申请路径/u },
  { cue: "岗位真实性核验单：排查挂名招聘", usedWhen: /岗位.*真实性.*核验|挂名招聘/u },
  { cue: "招聘中介授权页：确认代表哪家公司", usedWhen: /招聘中介.*授权|代表.*公司/u },
];
...
const OVERSEAS_SUPERLATIVE_ANGLES: ContrarianAngle[] = [
  ...
  { cue: "背调最容易卡住的授权确认", usedWhen: /背调.*最.*授权|授权.*背调/u },
  { cue: "跨国推荐人最容易漏的时区", usedWhen: /推荐人.*最.*时区|时区.*推荐人/u },
  { cue: "在线测评最容易忽略的浏览器要求", usedWhen: /测评.*最.*浏览器|浏览器.*测评/u },
  { cue: "视频面试最容易翻车的收音设置", usedWhen: /视频面试.*最.*收音|收音.*面试/u },
  { cue: "作品集最危险的一项保密违规", usedWhen: /作品集.*最.*保密|保密.*作品集/u },
  { cue: "签证最容易看错的准确到期日", usedWhen: /签证.*最.*到期|到期日.*签证/u },
  { cue: "岗位最容易误读的工作地点", usedWhen: /岗位.*最.*地点|工作地点.*误读/u },
  { cue: "试用期最容易漏的薪资变化", usedWhen: /试用期.*最.*薪资|薪资.*试用期/u },
  { cue: "搬迁补贴最容易漏的返还条件", usedWhen: /搬迁补贴.*最.*返还|返还.*搬迁/u },
  { cue: "签字费最容易忽略的追回条款", usedWhen: /签字费.*最.*追回|追回.*签字费/u },
  { cue: "医疗保险最容易漏的等待期", usedWhen: /医疗保险.*最.*等待|等待期.*保险/u },
  { cue: "年假最容易算错的重置日期", usedWhen: /年假.*最.*重置|重置.*年假/u },
  { cue: "加班制度最容易看漏的补偿方式", usedWhen: /加班.*最.*补偿|补偿方式.*加班/u },
  { cue: "劳动合同最危险的签约主体", usedWhen: /合同.*最危险.*主体|签约主体/u },
  { cue: "跨境薪资最容易混淆的结算币种", usedWhen: /薪资.*最.*币种|结算币种/u },
  { cue: "两地工作最容易漏的税务居民身份", usedWhen: /两地.*最.*税务|税务居民/u },
  { cue: "入职最容易卡住的银行账户期限", usedWhen: /入职.*最.*银行|银行账户.*期限/u },
  { cue: "海外入职最容易漏的无犯罪证明", usedWhen: /入职.*最.*无犯罪|无犯罪证明/u },
  { cue: "材料翻译最容易失效的认证日期", usedWhen: /翻译.*最.*认证|认证日期.*翻译/u },
  { cue: "学历核验最容易混淆的学位等级", usedWhen: /学历.*最.*学位等级|学位等级/u },
  { cue: "入职日期最容易撞上的课程结束日", usedWhen: /入职日期.*最.*课程|课程结束日/u },
  { cue: "实习转正最容易误判的学生身份", usedWhen: /实习转正.*最.*学生身份|学生身份.*转正/u },
  { cue: "毕业项目最危险的一项保密边界", usedWhen: /毕业项目.*最.*保密|保密边界.*毕业/u },
  { cue: "跨时区网申最容易算错的截止时刻", usedWhen: /网申.*最.*截止|截止时刻.*网申/u },
  { cue: "远程岗位最容易漏的工作国家限制", usedWhen: /远程岗位.*最.*国家|工作国家.*远程/u },
  { cue: "离开实习最容易漏的设备归还", usedWhen: /实习.*最.*设备|设备归还/u },
  { cue: "中介岗位最危险的一项授权核验", usedWhen: /中介.*最危险.*授权|授权核验.*中介/u },
  { cue: "岗位编码最容易藏住的真实级别", usedWhen: /岗位编码.*最.*级别|真实级别.*编码/u },
  { cue: "薪资数字最容易看错的年月口径", usedWhen: /薪资.*最.*年月|年月.*薪资/u },
  { cue: "奖金最容易混淆的保底与目标口径", usedWhen: /奖金.*最.*保底|保底.*目标.*奖金/u },
  { cue: "管培项目最容易错过的统一入职窗", usedWhen: /管培.*最.*入职|统一入职/u },
  { cue: "工签办理最容易误判的担保时点", usedWhen: /工签.*最.*担保.*时点|担保时点/u },
  { cue: "背调最容易卡住的法定姓名差异", usedWhen: /背调.*最.*姓名|法定姓名/u },
  { cue: "成绩单最容易漏掉的姓名不一致", usedWhen: /成绩单.*最.*姓名|姓名.*成绩单/u },
];
...
const OVERSEAS_TUG_OF_WAR_ANGLES: TugOfWarAngle[] = [
  ...
  { cue: "雇主担保确定性 vs 更大的成长空间", usedWhen: /(?:雇主担保|工签).*(?:成长|空间)|成长.*担保/u },
  { cue: "先接早到的Offer vs 等目标岗位结果", usedWhen: /(?:早到|先接).*Offer.*(?:目标|等待)|目标岗.*Offer/iu },
  { cue: "留当前实习争取转正 vs 重投毕业生项目", usedWhen: /实习.*转正.*(?:毕业生|校招)|毕业生.*实习/u },
  { cue: "客户前台岗位 vs 后台研究岗位", usedWhen: /(?:前台|客户).*(?:后台|研究)|后台.*客户/u },
  { cue: "咨询公司项目制 vs 企业内部长期岗", usedWhen: /咨询.*(?:企业内部|长期)|企业.*咨询/u },
  { cue: "跨城市轮换计划 vs 固定一地深耕", usedWhen: /轮换.*(?:固定|城市)|固定.*轮换/u },
  { cue: "高固定薪酬 vs 更高奖金上限", usedWhen: /固定.*(?:奖金|上限)|奖金.*固定/u },
  { cue: "明确窄职责 vs 宽口径培养项目", usedWhen: /(?:窄|明确).*职责.*(?:宽|培养)|培养.*职责/u },
  { cue: "毕业生项目 vs 有经验岗位", usedWhen: /毕业生.*(?:经验|社招)|有经验.*毕业/u },
  { cue: "先等正式成绩单 vs 用在读证明入职", usedWhen: /成绩单.*(?:在读证明|入职)|在读证明/u },
  { cue: "频繁出差见客户 vs 固定地点做分析", usedWhen: /出差.*(?:固定|分析)|固定.*出差/u },
  { cue: "看公司使命感 vs 看直属经理质量", usedWhen: /公司.*使命.*(?:经理|直属)|使命感.*经理/u },
  { cue: "现金薪酬更高 vs 长期股权空间", usedWhen: /现金薪酬.*股权|股权.*现金薪酬/u },
  { cue: "先回家休整 vs 毕业后直接入职", usedWhen: /回家.*(?:休整|入职)|休整.*入职/u },
  { cue: "留本专业路线 vs 转产品岗位", usedWhen: /本专业.*产品|产品岗位.*专业/u },
  { cue: "公共部门稳定路径 vs 初创公司快速成长", usedWhen: /公共部门.*初创|初创.*公共/u },
  { cue: "本地企业海外岗 vs 跨国公司中国岗", usedWhen: /本地企业.*跨国|跨国.*中国岗/u },
  { cue: "接受搬迁补贴异地走 vs 留熟悉城市慢慢找", usedWhen: /搬迁补贴.*(?:城市|异地)|熟悉城市.*搬迁/u },
  { cue: "先签有截止期的岗位 vs 等奖学金项目结果", usedWhen: /截止.*(?:奖学金|岗位)|奖学金.*岗位/u },
  { cue: "保留专业技术路线 vs 转客户解决方案", usedWhen: /技术.*(?:客户|解决方案)|解决方案.*技术/u },
  { cue: "选择独立负责项目 vs 进入成熟分工团队", usedWhen: /独立.*项目.*成熟|成熟.*分工.*独立/u },
  { cue: "先拿本地工作经验 vs 直接回国参加校招", usedWhen: /本地.*经验.*回国|回国.*本地.*经验/u },
  { cue: "接受实习转正 vs 重新申请正式全职岗", usedWhen: /实习转正.*全职|全职.*转正/u },
  { cue: "优先签证稳定 vs 优先能力成长速度", usedWhen: /签证.*能力成长|成长.*签证/u },
  { cue: "马上入职普通岗 vs 等评估中心结果", usedWhen: /入职.*评估中心|评估中心.*入职/u },
  { cue: "混合办公弹性 vs 每周固定到岗", usedWhen: /混合办公.*到岗|到岗.*混合/u },
  { cue: "更高到手薪资 vs 更完整养老福利", usedWhen: /到手.*养老|养老福利.*薪资/u },
  { cue: "职位级别更高 vs 实际职责更核心", usedWhen: /职位级别.*职责|实际职责.*级别/u },
  { cue: "加入全球远程团队 vs 本地线下协作", usedWhen: /全球.*本地.*协作|远程团队.*本地/u },
  { cue: "毕业后马上工作 vs 保留毕业旅行", usedWhen: /工作.*毕业旅行|毕业旅行.*工作/u },
  { cue: "公司住房补贴 vs 更高现金薪酬", usedWhen: /住房补贴.*现金|现金.*住房/u },
  { cue: "第三方代理合同 vs 公司直接雇佣", usedWhen: /代理合同.*直|直接雇佣.*代理/u },
  { cue: "口头晋升承诺 vs 清晰首年任务", usedWhen: /晋升承诺.*首年|首年任务.*晋升/u },
  { cue: "加入熟人团队 vs 跟随更强直属上级", usedWhen: /熟人团队.*直属|直属.*熟人/u },
  { cue: "监管行业稳定性 vs 科技行业速度", usedWhen: /监管行业.*科技|科技.*监管/u },
  { cue: "职责范围更宽 vs 绩效指标更清晰", usedWhen: /职责.*指标|绩效指标.*职责/u },
  { cue: "工作时间稳定 vs 学习机会更多", usedWhen: /工作时间.*学习|学习机会.*工时/u },
  { cue: "名牌客户履历 vs 项目完整所有权", usedWhen: /名牌客户.*所有权|项目所有权.*客户/u },
  { cue: "到手收入更高 vs 签证确定性更强", usedWhen: /到手收入.*签证|签证.*收入/u },
  { cue: "留喜欢的城市 vs 去机会更密集的城市", usedWhen: /喜欢.*城市.*机会|机会.*城市/u },
  { cue: "数据分析专业岗 vs 产品运营综合岗", usedWhen: /数据分析.*产品运营|产品运营.*数据/u },
  { cue: "内部研究岗位 vs 面向客户交付岗位", usedWhen: /内部研究.*客户交付|客户交付.*研究/u },
  { cue: "海归专项项目 vs 普通部门招聘", usedWhen: /海归.*普通部门|专项项目.*部门/u },
  { cue: "加入校友创业团队 vs 独立寻找机会", usedWhen: /校友.*创业.*独立|独立.*校友/u },
  { cue: "接受员工宿舍 vs 争取更高现金补贴", usedWhen: /员工宿舍.*现金|现金补贴.*宿舍/u },
  { cue: "固定部门归属 vs 跨项目灵活派遣", usedWhen: /固定部门.*项目|项目.*派遣/u },
  { cue: "追逐AI热门岗位 vs 积累长期能力", usedWhen: /AI.*长期能力|长期.*AI/iu },
  { cue: "直属经理口碑 vs 正式培训体系", usedWhen: /直属经理.*培训|培训体系.*经理/u },
  { cue: "本币稳定薪资 vs 跨境浮动收入", usedWhen: /本币.*跨境|跨境.*薪资/u },
  { cue: "成熟业务接手 vs 从零建设新项目", usedWhen: /成熟业务.*从零|从零.*成熟/u },
  { cue: "服务本地客户 vs 参与国际业务", usedWhen: /本地客户.*国际|国际业务.*本地/u },
  { cue: "固定工作地点 vs 多城市项目机会", usedWhen: /固定.*地点.*多城|多城市.*固定/u },
];
...
const EXECUTIVE_TUG_OF_WAR_ANGLES: TugOfWarAngle[] = [
  ...
  { cue: "等股权归属兑现 vs 抓住外部岗位窗口", usedWhen: /股权.*外部.*窗口|外部岗位.*归属/u },
  { cue: "等年终奖到账 vs 立即进入新赛道", usedWhen: /年终奖.*新赛道|新赛道.*年终奖/u },
  { cue: "签长期激励计划 vs 保留职业流动性", usedWhen: /长期激励.*流动|职业流动.*激励/u },
  { cue: "接受空降一号位 vs 先做业务顾问", usedWhen: /空降.*顾问|顾问.*一号位/u },
  { cue: "进入董事会角色 vs 保持一线经营职责", usedWhen: /董事会.*一线经营|经营职责.*董事会/u },
  { cue: "接亏损业务翻盘 vs 做新增长业务", usedWhen: /亏损.*增长|翻盘.*增长业务/u },
  { cue: "守核心城市市场 vs 去下沉市场拿全盘", usedWhen: /核心城市.*下沉|下沉市场.*城市/u },
  { cue: "进国企稳任期 vs 去民企拼经营结果", usedWhen: /国企.*民企|民企.*国企/u },
  { cue: "继续全职高管 vs 组合多家顾问项目", usedWhen: /全职高管.*顾问|多家顾问.*全职/u },
  { cue: "只服务一个雇主 vs 建立多客户组合", usedWhen: /一个雇主.*多客户|多客户.*雇主/u },
  { cue: "高头衔无利润责任 vs 低头衔管完整利润", usedWhen: /高头衔.*利润|低头衔.*利润/u },
  { cue: "接全球职能岗位 vs 管国内完整业务盘", usedWhen: /全球职能.*国内|国内.*全球/u },
  { cue: "自己从零创业 vs 加入成熟创业团队", usedWhen: /自己.*创业.*成熟|成熟创业.*自己/u },
  { cue: "先找投资合伙人 vs 先跑正向现金流", usedWhen: /投资合伙.*现金流|现金流.*投资/u },
  { cue: "接大客户定制项目 vs 做标准化产品", usedWhen: /大客户.*标准化|标准化产品.*客户/u },
  { cue: "靠个人品牌获客 vs 建立渠道合作", usedWhen: /个人品牌.*渠道|渠道合作.*品牌/u },
  { cue: "先招核心团队 vs 先跑出真实订单", usedWhen: /招.*团队.*订单|订单.*团队/u },
  { cue: "完成长通知期交接 vs 买断后尽快离开", usedWhen: /通知期.*买断|买断.*交接/u },
  { cue: "接受异地任职 vs 保留远程顾问方式", usedWhen: /异地任职.*远程|远程顾问.*异地/u },
  { cue: "继续管理团队 vs 转个人贡献者角色", usedWhen: /管理团队.*个人贡献者|个人贡献者.*团队/u },
  { cue: "去老行业新公司 vs 用老职能进新行业", usedWhen: /老行业.*新行业|新行业.*老职能/u },
  { cue: "选上市前股权空间 vs 上市公司现金回报", usedWhen: /上市前.*上市公司|股权.*现金回报/u },
  { cue: "接短期扭亏任务 vs 做长期增长建设", usedWhen: /扭亏.*长期增长|增长建设.*扭亏/u },
  { cue: "直接向董事会汇报 vs 向创始人汇报", usedWhen: /董事会.*创始人|创始人.*董事会/u },
  { cue: "接区域负责人岗位 vs 留总部职能岗", usedWhen: /区域负责人.*总部|总部职能.*区域/u },
  { cue: "保递延奖金到账 vs 抓当前市场窗口", usedWhen: /递延奖金.*市场窗口|市场窗口.*奖金/u },
  { cue: "接受竞业补偿等待 vs 放弃补偿去入职", usedWhen: /竞业补偿.*放弃|放弃补偿.*竞业/u },
  { cue: "加入合伙人机制 vs 保持职业雇员身份", usedWhen: /合伙人.*雇员|雇员.*合伙/u },
  { cue: "接家族企业改造 vs 去职业经理人公司", usedWhen: /家族企业.*职业经理|职业经理.*家族/u },
  { cue: "做大客户项目制业务 vs 做规模化用户业务", usedWhen: /大客户.*规模化|规模化.*客户/u },
  { cue: "先补财务经营能力 vs 先补产品能力", usedWhen: /财务.*产品能力|产品能力.*财务/u },
  { cue: "继续企业服务业务 vs 转消费用户业务", usedWhen: /企业服务.*消费|消费用户.*企业/u },
  { cue: "接完整利润责任 vs 做专项变革负责人", usedWhen: /利润责任.*专项|专项变革.*利润/u },
];
...
const OVERSEAS_NOSTALGIA_ANGLES: NostalgiaAngle[] = [
  ...
  { cue: "过去开学生银行账户，如今核对薪资账户", usedWhen: /银行账户.*薪资|薪资账户.*银行/u },
  { cue: "过去办城市交通卡，如今计算通勤月成本", usedWhen: /交通卡.*通勤|通勤.*交通卡/u },
  { cue: "过去选手机套餐，如今确保招聘电话畅通", usedWhen: /手机套餐.*招聘|招聘电话.*套餐/u },
  { cue: "过去看迎新手册，如今读员工手册", usedWhen: /迎新手册.*员工|员工手册.*迎新/u },
  { cue: "过去领校园门禁，如今申请办公权限", usedWhen: /校园门禁.*办公|办公权限.*门禁/u },
  { cue: "过去抢图书馆座位，如今订线上面试房间", usedWhen: /图书馆座位.*面试|面试房.*图书馆/u },
  { cue: "过去参加社团招新，如今参加企业人才日", usedWhen: /社团招新.*人才|人才日.*社团/u },
  { cue: "过去约写作中心，如今修改求职邮件", usedWhen: /写作中心.*求职邮件|求职邮件.*写作/u },
  { cue: "过去看考试周，如今安排面试周", usedWhen: /考试周.*面试|面试周.*考试/u },
  { cue: "过去借毕业袍，如今准备面试职业装", usedWhen: /毕业袍.*职业装|职业装.*毕业/u },
  { cue: "过去办医疗注册，如今比较员工医保", usedWhen: /医疗注册.*医保|员工医保.*医疗/u },
  { cue: "过去找合租室友，如今核对搬迁城市", usedWhen: /合租室友.*搬迁|搬迁.*室友/u },
  { cue: "过去交宿舍押金，如今核对Offer签字费", usedWhen: /宿舍押金.*签字费|签字费.*押金/u },
  { cue: "过去看公交站点，如今计算办公地通勤", usedWhen: /公交.*办公地|办公地.*公交/u },
  { cue: "过去上传课程作业，如今上传岗位作品集", usedWhen: /课程作业.*作品集|作品集.*作业/u },
  { cue: "过去等论文反馈，如今等面试反馈", usedWhen: /论文反馈.*面试|面试反馈.*论文/u },
  { cue: "过去参加职业讲座，如今参加公司面谈", usedWhen: /职业讲座.*面谈|公司面谈.*讲座/u },
  { cue: "过去做课堂展示，如今练业务汇报", usedWhen: /课堂展示.*汇报|业务汇报.*课堂/u },
  { cue: "过去写学习日志，如今写求职复盘", usedWhen: /学习日志.*求职|求职复盘.*日志/u },
  { cue: "过去排假期旅行，如今安排入职窗口", usedWhen: /假期旅行.*入职|入职窗口.*旅行/u },
  { cue: "过去领毕业证明，如今准备学历认证", usedWhen: /毕业证明.*学历认证|学历认证.*毕业/u },
  { cue: "过去办校内兼职许可，如今核对工作许可", usedWhen: /兼职许可.*工作许可|工作许可.*兼职/u },
  { cue: "过去找学术导师，如今评估直属经理", usedWhen: /学术导师.*直属经理|直属经理.*导师/u },
  { cue: "过去选交换项目，如今选择轮岗安排", usedWhen: /交换项目.*轮岗|轮岗.*交换/u },
  { cue: "过去申请宿舍，如今比较租房补贴", usedWhen: /申请宿舍.*租房|租房补贴.*宿舍/u },
  { cue: "过去办校园保险，如今阅读员工福利", usedWhen: /校园保险.*福利|员工福利.*保险/u },
  { cue: "过去参加校友晚宴，如今约岗位访谈", usedWhen: /校友晚宴.*访谈|岗位访谈.*晚宴/u },
  { cue: "过去保存课程作业，如今整理能力样本", usedWhen: /课程作业.*能力样本|能力样本.*作业/u },
  { cue: "过去等成绩公布，如今等待背调结果", usedWhen: /成绩公布.*背调|背调结果.*成绩/u },
  { cue: "过去练学术引用，如今练数据表达", usedWhen: /学术引用.*数据表达|数据表达.*引用/u },
  { cue: "过去申请作业延期，如今协商入职延期", usedWhen: /作业延期.*入职|入职延期.*作业/u },
  { cue: "过去换专业方向，如今判断转岗成本", usedWhen: /专业方向.*转岗|转岗成本.*专业/u },
  { cue: "过去选毕业论文题，如今选第一份岗位", usedWhen: /论文题.*第一份岗位|第一份岗位.*论文/u },
  { cue: "过去搬进学生宿舍，如今准备跨城入职", usedWhen: /学生宿舍.*跨城|跨城入职.*宿舍/u },
  { cue: "过去约语言伙伴，如今练中文面试", usedWhen: /语言伙伴.*中文面试|中文面试.*伙伴/u },
  { cue: "过去申请会议差旅，如今核对岗位出差强度", usedWhen: /会议差旅.*出差|出差强度.*会议/u },
  { cue: "过去看学校日历，如今看招聘批次", usedWhen: /学校日历.*招聘|招聘批次.*日历/u },
  { cue: "过去加入学习小组，如今找模拟面试搭档", usedWhen: /学习小组.*面试|面试搭档.*小组/u },
  { cue: "过去交图书馆罚金，如今核对Offer违约金", usedWhen: /图书馆罚.*违约|违约金.*图书馆/iu },
];
...
const EXECUTIVE_NOSTALGIA_ANGLES: NostalgiaAngle[] = [
  ...
  { cue: "过去发部门周报，如今发个人服务方案", usedWhen: /部门周报.*个人服务|个人服务.*周报/u },
  { cue: "过去参加老板会，如今约潜在客户", usedWhen: /老板会.*潜在客户|潜在客户.*老板/u },
  { cue: "过去看下属绩效，如今看自己市场反馈", usedWhen: /下属绩效.*市场反馈|市场反馈.*绩效/u },
  { cue: "过去签供应商合同，如今签个人顾问协议", usedWhen: /供应商合同.*顾问|顾问协议.*供应商/u },
  { cue: "过去给团队调薪，如今比较自己的市场报价", usedWhen: /团队调薪.*报价|市场报价.*调薪/u },
  { cue: "过去做人才盘点，如今盘个人能力资产", usedWhen: /人才盘点.*能力|能力资产.*人才/u },
  { cue: "过去审批差旅行程，如今计算面试路程", usedWhen: /审批差旅.*面试|面试路程.*差旅/u },
  { cue: "过去主持团队晨会，如今准备自我介绍", usedWhen: /晨会.*自我介绍|自我介绍.*晨会/u },
  { cue: "过去给新人定目标，如今写自己的90天计划", usedWhen: /新人.*目标.*90天|90天.*新人/u },
  { cue: "过去看客户满意度，如今看个人服务复购", usedWhen: /客户满意度.*复购|复购.*满意/u },
  { cue: "过去核费用报销，如今计算创业现金流", usedWhen: /费用报销.*现金流|创业现金流.*报销/u },
  { cue: "过去定年度战略，如今验证一周假设", usedWhen: /年度战略.*假设|一周假设.*战略/u },
  { cue: "过去参加行业峰会，如今约从业者访谈", usedWhen: /行业峰会.*访谈|从业者访谈.*峰会/u },
  { cue: "过去分配团队奖金，如今拆个人收入结构", usedWhen: /团队奖金.*个人收入|收入结构.*奖金/u },
  { cue: "过去做风控报告，如今核转型停止条件", usedWhen: /风控报告.*停止|停止条件.*风控/u },
  { cue: "过去签公司保密协议，如今划个人表达边界", usedWhen: /保密协议.*表达|表达边界.*保密/u },
  { cue: "过去给团队招人，如今找自己的背调证明人", usedWhen: /团队招人.*证明人|背调证明人.*招人/u },
  { cue: "过去选办公地点，如今选下一份工作的城市", usedWhen: /办公地点.*工作城市|工作城市.*办公/u },
  { cue: "过去批采购清单，如今列能力补课清单", usedWhen: /采购清单.*补课|能力补课.*采购/u },
  { cue: "过去看公司市场份额，如今看个人获客率", usedWhen: /市场份额.*获客|个人获客.*份额/u },
  { cue: "过去开经营复盘会，如今复盘一次外部面试", usedWhen: /经营复盘.*面试|面试.*复盘会/u },
  { cue: "过去做客户分层，如今筛第一批咨询客户", usedWhen: /客户分层.*咨询|咨询客户.*分层/u },
  { cue: "过去定销售目标，如今验证第一笔个人成交", usedWhen: /销售目标.*个人成交|第一笔.*成交.*销售/u },
  { cue: "过去管供应链，如今计算独立交付周期", usedWhen: /供应链.*交付周期|独立交付.*供应/u },
  { cue: "过去评合作伙伴，如今评估新公司的老板", usedWhen: /合作伙伴.*新公司|新公司.*老板.*伙伴/u },
  { cue: "过去做年度述职，如今讲离开平台后的自己", usedWhen: /年度述职.*离开平台|离开平台.*述职/u },
  { cue: "过去招管理培训生，如今参加反向面试", usedWhen: /管理培训生.*反向面试|反向面试.*培训生/u },
  { cue: "过去签业务授权书，如今问新岗位决策边界", usedWhen: /授权书.*决策边界|决策边界.*授权/u },
  { cue: "过去审批招聘名额，如今确认新岗团队配置", usedWhen: /招聘名额.*团队配置|团队配置.*招聘/u },
  { cue: "过去定部门OKR，如今写个人验证目标", usedWhen: /部门.*OKR.*个人|个人验证.*OKR/iu },
  { cue: "过去看员工敬业度，如今看家人的支持度", usedWhen: /员工敬业.*家人|家人.*支持度/u },
  { cue: "过去谈总部资源，如今盘点能带走的资产", usedWhen: /总部资源.*带走|带走.*总部/u },
  { cue: "过去做危机预案，如今设转型止损线", usedWhen: /危机预案.*止损|转型止损.*预案/u },
  { cue: "过去主持客户提案，如今讲自己的项目案例", usedWhen: /客户提案.*个人案例|项目案例.*提案/u },
  { cue: "过去庆祝团队达标，如今验证个人报价", usedWhen: /团队达标.*个人报价|个人报价.*达标/u },
];
...
export function buildTopicPoolUserPrompt(input: {
  ...
  /** 常规批次保持3条；定向补题可扩大候选池，避免一个旧题耗尽整个槽位。 */
  candidateCount?: 3 | 5;
...
请主动更换具体人物、场景、动作、冲突或阶段结果。`
  ...
  const candidateExamples = Array.from({ length: candidateCount }, (_, index) => (
    `        {"title": "候选题目${index + 1}（20字以内，含标点）", "title_promise": "候选题目${index + 1}正文必须兑现的唯一承诺"}`
  )).join(",\n");
...
- 每种方法同时给出 ${candidateCount} 个彼此明显不同的 title_candidates。候选不能只是改标点、数字或语气词，必须主动轮换句式和具体素材，但仍严格属于同一个方法。${singleTitleRewrite ? `当前是单槽改写，${candidateCount}个候选必须保持方向锁中的目标用户、核心处境、正文承诺和数量完全不变；所有 title_promise 都原样返回方向锁中的正文唯一承诺。` : ""}
...
1.1 当前人设的时间状态是事实边界。若人设已经裸辞、离职、被裁或待业，不得把“今天到原公司上班、参加原公司会议、刚被移出原公司群”等写成正在发生；若必须回忆，只能明确写“裸辞前、离职前、还在职时”。
...
3.1 正文骨架自己若写“3件事、2步、4点”等新的数量承诺，也必须在 delivery_sections 中逐项写满；普通标题不要临时追加无法完整交付的数字钩子。
...
- 【人设时间线硬规则】正文中的“今天、今早、刚刚、现在”必须与账号当前状态一致。人设若已经裸辞、离职、被裁或待业，不得写成今天仍在原公司上班、参加原公司会议或刚被移出原公司群；历史事件必须明确加“裸辞前、离职前、还在职时”等时间标记。
- 标题有数字，正文必须给出同等数量的有效内容；承诺资料、清单或路线图时必须直接交付核心内容。
- 正文自己若提出“3件事、2步、4点”等数量承诺，也必须用“第一、第二……”或编号逐项写满。禁止出现“先确认三件事：第一”后没有第二、第三的半截清单。
