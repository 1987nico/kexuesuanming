...
export const TOPIC_PREFETCH_GENERATION_VERSION = "topic-prefetch-v8-direct-benchmark-title" as const;
...
export const DRAFT_PREWARM_GENERATION_VERSION = "draft-prewarm-v9-business-safe-comparison" as const;
