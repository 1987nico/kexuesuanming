...
const CONFLICT_PATTERNS: Array<[string, RegExp]> = [
  ...
  ["parent_job_search_pressure", /(?:爸妈|父母|家里|家长).*(?:秋招|求职|投简历|面试|笔试).*(?:不敢|没方向|方向模糊|全挂|没回音|其实|以为|乱投)|(?:不敢|没方向|方向模糊|全挂|没回音|其实|以为|乱投).*(?:爸妈|父母|家里|家长).*(?:秋招|求职|投简历|面试|笔试)|(?:爸妈|父母|家里|家长).*(?:不敢|没方向|方向模糊|全挂|没回音|其实|以为|乱投).*(?:秋招|求职|投简历|面试|笔试)/gu],
